...
namespace MuseumApplication.Web.Controllers
{
    public class VisitorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,Email,MembershipDate,MembershipType")] Visitor visitor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,FirstName,LastName,Email,MembershipDate,MembershipType")] Visitor visitor)
        {
            if (id != visitor.Id)
            {
                return NotFound();
