...
namespace MuseumApplication.Web.Controllers
{
    public class CollectionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Currator")] Collection collection)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Name,Currator")] Collection collection)
        {
            if (id != collection.Id)
            {
                return NotFound();
